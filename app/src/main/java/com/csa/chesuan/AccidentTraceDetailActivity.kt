...
import com.csa.chesuan.databinding.ActivityAccidentTraceDetailBinding
import com.csa.chesuan.trace.AccidentDetailBundle
import com.csa.chesuan.trace.AccidentEvent
import com.csa.chesuan.trace.AccidentSiteCoordinates
import com.csa.chesuan.trace.AccidentTraceViewModel
import com.csa.chesuan.trace.AccidentType
import com.csa.chesuan.trace.CollisionSeverityPredictionResult
import com.csa.chesuan.trace.DeepLearningResult
import com.csa.chesuan.trace.ExperimentRuntime
import com.csa.chesuan.trace.ResponsibilityAnalyzer
import com.csa.chesuan.trace.TelemetryPoint
        ...
        binding.btnUploadChain.setOnClickListener {
            ...
            lifecycleScope.launch {
                ...
                if (result.success) {
                    ...
                    if (result.txId.isNotBlank()) {
                        binding.tvChainTxLabel.visibility = View.VISIBLE
                        binding.tvChainTxId.visibility = View.VISIBLE
                        binding.tvChainTxId.text = result.txId
                    } else {
                        binding.tvChainTxLabel.visibility = View.GONE
                        binding.tvChainTxId.visibility = View.GONE
                    }
