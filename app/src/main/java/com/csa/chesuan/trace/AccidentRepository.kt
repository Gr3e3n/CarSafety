...
object AccidentRepository {
    ...
    fun generateEvidence(bundle: AccidentDetailBundle): EvidenceRecord {
        ...
        scope.launch {
            dao?.insertEvidence(
                com.csa.chesuan.db.EvidenceEntity(
    ...
    private fun com.csa.chesuan.db.AccidentEventEntity.toAccidentEvent(): AccidentEvent {
    ...
    private fun com.csa.chesuan.db.ResponsibilityEntity.toResponsibilityResult(): ResponsibilityResult {
