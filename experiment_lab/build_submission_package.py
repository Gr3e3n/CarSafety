...
RESULTS = LAB / "results"
RAW_RESULTS = RESULTS / "files" if (RESULTS / "files").is_dir() else RESULTS / "result"
ANALYSIS = RESULTS / "analysis"
OUT = RESULTS / "submission_package_ready"
...
| 模型结果文件 | `{RAW_RESULTS.relative_to(ROOT)}/cloud_experiment_results_*.json` |
